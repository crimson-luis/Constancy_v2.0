...
def send_mail(user, new_password, receiver):
    ...
    text = (
        ...
        "\nA sua nova senha é: {new_password}."
    ).format(user=user, new_password=new_password)
    ...
    constancy_image = (
        "C:/Users/luisg/OneDrive/Documentos/Python_Scripts/"
...
if __name__ == "__main__":
    parser = ArgumentParser(description="Create a ArcHydro schema")
    parser.add_argument(
        "--user", metavar="path", required=True, help="the path to workspace"
    )
    parser.add_argument(
        "--new_password", metavar="path", required=True, help="path to schema"
    )
    parser.add_argument("--receiver", metavar="path", required=True, help="path to dem")
